...
sshpass -p "Ricard0Espech3" ssh incloux@45.55.102.85 -p 2298 "rm -rf /var/www/invesafe2.site/*;unzip -qq /var/www/site.zip -d /var/www/invesafe2.site/;rm /var/www/site.zip"
