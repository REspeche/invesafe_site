mainApp.factory('modalSvc', ['$uibModal', '$window', 'CONSTANTS',
        function ($uibModal, $window, CONSTANTS) {
            var publicFunctions = {
                'showModal': showModal,
                'showPopup': showPopup,
                'showModalWithFile': showModalWithFile,
                'showModalWithBase64': showModalWithBase64,
            };
            ...
            function showModalWithBase64(base64) {
                var openFile = $window.open('', '_blank', 'toolbar=no, menubar=no, resizable=yes');
                openFile.document.write('<body style="margin:0; background: #0e0e0e;"><img src="' + base64 + '" style="width:100%;"/></body>');
            };
